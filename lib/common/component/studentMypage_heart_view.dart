...
class StudentmypageHeartScreen extends StatefulWidget {
  const StudentmypageHeartScreen({super.key});

  @override
  State<StudentmypageHeartScreen> createState() =>
      _StudentmypageHeartViewState();
}

class _StudentmypageHeartViewState extends State<StudentmypageHeartScreen> {
